...
4. Read **architecture** documents for system structure and data flows.
5. Review the **threat model** before designing agents, tools, or integrations.
6. Consult **ADRs** when making or reviewing technical decisions.
