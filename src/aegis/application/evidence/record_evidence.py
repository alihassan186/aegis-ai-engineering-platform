"""Record evidence against an incident (FR-017, FR-018).
...
Redaction is a no-op until Step 4.7.
"""
...
def apply_redaction(text: str) -> str:
    """Pass-through until the secrets pipeline (Step 4.7 / FR-019)."""
    return text


def _cap(text: str) -> str:
    stripped = apply_redaction(text.strip())
    ...
    async def execute(
        ...
        *,
        ...
        evidence = Evidence.create(
            ...
            summary=apply_redaction(summary),
            metadata=metadata,
